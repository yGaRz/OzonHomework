...
Задание на 10 балов
Для внутренних сервисов написаны UnitTest. 
Написать (переписать) тесты с учетом репозитория. 
Тесты для самого репозитория делать не надо. 
Во внутренних сервисах абстрактный репозиторий следует замокать(moq)
