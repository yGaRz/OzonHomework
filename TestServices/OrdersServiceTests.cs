...
public class OrdersServiceTests
{
    ...
    //{
    //    var mockOrders = new Mock<IOrdersManager>();
    //    var context = TestServerCallContext.Create();
    //    int idOrder = 1;
    ...
    //        };
    //        return new OrderDao(1, OrderSourceEnum.Api, OrderStateEnum.Created, 1, address, new List<ProductDto>());
    //    });
    ...
    //            LastName = "Surname",
    //            Email = "xxx@yyy.ru",
    //            DefaultAddress = new Ozon.Route256.Practice.OrdersService.Application.Dto.AddressDto("", "", "", "", "", 1, 1),
    //            Phone = ""
    //        };
    //    }
    //        );
    //    var request = new GetOrdersByCustomerIDRequest() { Id = id, PageIndex = 1, PageSize = 20, StartTime = DateTime.Now.ToUniversalTime().ToTimestamp() };
    //    IOrdersManager rep = new OrdersManager(null, null);
